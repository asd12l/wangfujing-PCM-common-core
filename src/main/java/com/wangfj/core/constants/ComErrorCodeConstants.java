...
public class ComErrorCodeConstants {
  public enum ErrorCode {
    ...
    STOCK_OUTOFSTOCK_ERROR("00301101", "锁定数量大于可售库存数量"), STOCK_LOCK_SUCCEED("00301102", "锁库成功"), STOCK_LOCK_FAILED_ERROR(
        ...
        "00301131", "可售库存不能小于0"), SKU_NOT_SALE("00301132", "商品不可售"),NOT_XKORXXHC(
        "00301133", "专柜商品既不是虚库商品又不是先销后采商品"), NOT_ASSOCIATED(
        "00301134", "专柜商品非联营商品"),STOCK_TYPE_IS_ERROR("00301135", "库位操作类型为空或不正确"),
    /* 商品图片 302 孔庆富 */
