...
import com.wangfj.core.cache.MongodbVo;
...
public class CacheUtils {
	 ...
	 * @return
	 */
	public static <T> List<T> getRedisList(String key, Class<T> claz, int start, int end) {
	 ...
	 * @param String
	 */
	public static void setRedisData(String obj) {

		RedisVo rv = new RedisVo();
	...
	public static void flushRedisData() {
		...
		for (RedisVo redisVo : list) {
			if (HSET == redisVo.getType()) {
				redisUtil.setHSet(redisVo.getField(), redisVo.getKey(), redisVo.getValue());
