...
//    		        try {
//    		        	 lock = new DistributedLock("10.6.2.43:2181","test1");
//    		             lock.lock();
//    		        }catch (Exception e) {
//    		            e.printStackTrace();
//    		        }finally {
...
//    	}
    	DistributedLock lock = null;
        try {
        	 lock = new DistributedLock("10.6.2.78:2181,10.6.2.79:2181,10.6.2.80:2181,10.6.2.87:2181,10.6.2.88:2181","test1");
             lock.lock();
        }catch (Exception e) {
            e.printStackTrace();
        }finally {
