...
public class PropertyUtil {
    ...
    public final static boolean setValueAndStore(String propertyFilePath,
        ...
        try {
            ...
            String path = PropertyUtil.class.getResource(propertyFilePath)
                    .getPath();
    ...
    public final static String getSystemUrl(String key){
    	
    	return PropertyUtil.getValue("/application.properties",key);
