...
/**
 * 说 明 : 字符串处理工具类 author: 陆湘星 data : 2011-5-28 email : xiangxingchina@163.com
 **/
public class StringUtils extends org.apache.commons.lang.StringUtils {

	/**
	 * 判断一个字符串是否为空 不包括："", "null"
	 * 
	 * @param str
	 * @return
	 */
	...
	public static String replace(String replace) {
		String replace_new = replace.replaceAll("%", "//%");
		return replace_new;
	}
